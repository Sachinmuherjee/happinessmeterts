    ...
    <div className="container-fluid">
      ...
      <div className="container-fluid">
        <div className="row">
                ...
                <g data-name="Group 7" transform="translate(-1656 -61.129)">
                  ...
                  <g id="sad" transform="translate(1656 61.129)">
                    <path
                      id="Path_1"
                      data-name="Path 1"
                      d="M47.871,16A31.871,31.871,0,1,0,79.742,47.871,31.965,31.965,0,0,0,47.871,16Zm0,59.992A28.121,28.121,0,1,1,75.992,47.871,28.2,28.2,0,0,1,47.871,75.992Z"
                    ...
                    <path
                      id="Path_2"
                      data-name="Path 2"
                      d="M36.562,58.237a1.856,1.856,0,0,1,2.625-2.625,14.145,14.145,0,0,0,19.872,0,1.812,1.812,0,0,1,2.625,0,1.812,1.812,0,0,1,0,2.625A17.765,17.765,0,0,1,36.562,58.237Z"
                      transform="translate(-17.252 -16.571)"
                      fill="#830823"
                    />
                    <path
                      id="Path_7"
                      data-name="Path 7"
                      d="M32.645,40.113a.487.487,0,0,0,.812,0,12.486,12.486,0,0,1,1.973-2.031c1.393-1.1,3.539-2.2,2.785-4.816a3.074,3.074,0,0,0-5.164-1.16,3.074,3.074,0,0,0-5.164,1.16c-.754,2.611,1.393,3.771,2.785,4.816A12.735,12.735,0,0,1,32.645,40.113Z"
                      transform="translate(-9.781 -11.279)"
                      fill="#830823"
                    />
                    <path
                      id="Path_8"
                      data-name="Path 8"
                      d="M59.252,32.006a3.075,3.075,0,0,0-5.165,1.161c-.754,2.611,1.393,3.772,2.785,4.816a12.488,12.488,0,0,1,1.973,2.031.487.487,0,0,0,.812,0,12.488,12.488,0,0,1,1.973-2.031c1.393-1.1,3.54-2.205,2.785-4.816A3.075,3.075,0,0,0,59.252,32.006Z"
                      transform="translate(-18.577 -11.393)"
                      fill="#830823"
                    />
                  </g>
                </g>
          ...
          <div className="col-lg-4 col-md-4 ml-auto">
            <div className="hapmeterlogos" id="thirdmodel">
              <img src={dubalogo} alt="Clickable Button" />
            </div>
          </div>
        </div>
      </div>
